...
int main(void)
{
    ...
    /** Strip **/
    nd_init_strip_dims_c(&sliced_arr, (ND_indices)2, &stripped_arr /*nd_idx{1,0}*/);
    nd_strip_dims_c(&sliced_arr, (ND_indices)2, nd_idx{1,0}, &stripped_arr);
...
//     ND_indices pppp = 1000;

//     nd_malloc_c(&einsum_test,(ND_indices) 3, nd_idx{1,3,pppp});
//     //nd_malloc_c(&einsum_test,(ND_indices) 0, NULL);

//     nd_malloc_c(&mat_prod, (ND_indices) 2, nd_idx{pppp,pppp});
...
//     // nd_malloc_c(&sliced_arr, (ND_indices) 3, nd_idx{2,150,42} );
...
//     nd_malloc_c(&sliced_arr, (ND_indices) 3, nd_idx{2,75,5} );
