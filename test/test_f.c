...
int main(void)
{
    ...
    nd_write_s("nc.temp_2s", "exc_elph", &write_arr, (char * []) {"nq", "modes", "Sf", "Si", "re_im"});  
    nd_write_s("nc.temp_2ssub", "exc_elph", &read_sub_arr, (char * []) {"nq", "modes", "Sf", "Si", "re_im"});   
    ...
    /** Strip **/
    nd_init_strip_dims_s(&sliced_arr, (ND_indices)2, &stripped_arr /*nd_idx{1,0}*/);
    nd_strip_dims_s(&sliced_arr, (ND_indices)2, nd_idx{1,0}, &stripped_arr);
    ...
    nd_init_s(&mat_prod,(ND_indices)2, write_arr.dims+2 );
